                    ...
                    <div className="flex-1 w-full" >
                        <div className="relative flex items-baseline mb-4" >
                            ...
                            <div className="text-sm font-medium text-gray-900  ml-6">
                                ...
                                <span className=" text-venru-darkgray font-normal pt-2 text-sm   " >olivia@untitledui.com</span>
                            </div>
                        </div>
                    ...
                    <div className="flex-1 w-full " >
                        {cardDetails.map((details) => {
                            ...
                            >
                                ...
                                <label className={`text-sm  text-gray-900  ${details.id === check && "text-venru-purple"}  ml-20`}>
                                    <h1>{details.title} </h1>
                                    <p className="font-normal" >{details.title2} </p>
                                    <h1 className=" text-venru-purple font-normal pt-4 text-sm  " >Set as default <span className="ml-3 font-medium" > Edit </span> </h1>
                                </label>
                            </div>
                        })}
